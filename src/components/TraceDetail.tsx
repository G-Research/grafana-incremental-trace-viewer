              ...
              >
                {virtualItems.map((virtualItem) => {
                  ...
                  return (
                    <div
                      key={virtualItem.key}
                      className="absolute top-0 left-0 w-full border-b border-gray-300 light:border-gray-300 dark:border-gray-700"
                      style={{
                ...
                <div
                  ...
                  className="absolute top-0 h-full w-[6px] cursor-col-resize hover:bg-gray-400/50 light:hover:bg-gray-400/50 dark:hover:bg-gray-600/50 active:bg-gray-500/60 light:active:bg-gray-500/60 dark:active:bg-gray-500/60 z-10"
                />
              </div>
            </div>
          )}
