      ...
      <>
        <div className="flex flex-col items-center justify-center h-full p-4 text-center">
          <Icon
            name="calendar-slash"
            size="xxxl"
            className="text-gray-400 light:text-gray-400 dark:text-zinc-600 mb-5"
          />
          <h3 className="text-lg font-semibold mb-2 text-gray-900 light:text-gray-900 dark:text-white">
            No trace data available for this query
          </h3>
          <p className="text-md text-gray-600 light:text-gray-600 dark:text-zinc-400 mt-1">
      ...
      <>
        <div className="flex flex-col h-full">
          ...
          <div className="text-center flex-1 flex flex-col justify-center">
            ...
            <p className="text-gray-600 light:text-gray-600 dark:text-zinc-400">
              This panel requires a minimum size of 600x300 pixels.
            </p>
            <TextLink
              onClick={() => {
