...
export const SpanOverlayDrawer: React.FC<SpanOverlayDrawerProps> = ({
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-gray-900 light:bg-gray-900 dark:bg-black opacity-20 z-[998]"
        onClick={onClose}
      />
      ...
      <div
        ref={drawerRef}
        className="absolute top-0 right-0 h-full bg-white light:bg-white dark:bg-gray-800 border-l border-gray-300 light:border-gray-300 dark:border-gray-700 shadow-lg overflow-hidden z-[1000]"
        style={{
          width: drawerWidth,
      ...
      >
        ...
        <div
          ...
          className="absolute top-0 left-0 h-full w-[6px] cursor-col-resize hover:bg-gray-400/50 light:hover:bg-gray-400/50 dark:hover:bg-gray-600/50 active:bg-gray-500/60 light:active:bg-gray-500/60 dark:active:bg-gray-500/60 z-[1001]"
        >
        ...
        <div className="absolute top-0 right-0">
          <button
            onClick={onClose}
            className="p-1 rounded hover:bg-gray-200 light:hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            aria-label="Close drawer"
          >
            <Icon
              name="times"
              className="text-gray-500 light:text-gray-500 dark:text-gray-400 hover:text-gray-700 light:hover:text-gray-700 dark:hover:text-white"
            />
          </button>
        </div>
